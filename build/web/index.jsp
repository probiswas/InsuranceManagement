...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div class="logo">
        <h1><a href="index.jsp">Car Insurance</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>

      <button type="button" class="nav-toggle bg-light">Sign up</button>
      <!-- .nav-menu -->
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <h2>Fill this to login</h2>

      <form action="LoginUser" method="post" class="php-email-form">
        <div class="row no-gutters">
          <div class="col-md-6 form-group pr-md-1">
            <input type="text" name="emailAddress" class="form-control" type="email" id="email" placeholder="jhondoe@gmail.com" required>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="https://img.freepik.com/free-vector/car-crash-concept-illustration_114360-7980.jpg?w=996&t=st=1677034536~exp=1677035136~hmac=f54512bce6beb5bdfec06f0e4e3e94056ce20821a5ce006682c41542a480716a" class="img-fluid" alt="">
          </div>
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="img/why-us-2.jpg" class="card-img-top" alt="...">
              <div class="card-icon">
